...
export const DEFAULT_VIP_LEVELS: VIPPackage[] = [
  { 
    ...
    frameUrl: 'https://cdn-icons-png.flaticon.com/512/763/763328.png', 
    nameStyle: 'text-slate-200 font-bold',
    privileges: ['إطار فضي مميز', 'شارة الفارس في الملف الشخصي']
  },
  { 
    level: 5, 
    name: 'ماركيز', 
    ...
    frameUrl: 'https://cdn-icons-png.flaticon.com/512/5407/5407986.png', 
    nameStyle: 'text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 font-bold',
    privileges: ['إطار أرجواني فاخر', 'تأثير دخول مميز', 'أولوية في دعم العملاء']
  },
  { 
    level: 10, 
    name: 'أسطورة', 
    ...
    frameUrl: 'https://cdn-icons-png.flaticon.com/512/2618/2618413.png', 
    nameStyle: 'text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-400 to-amber-500 font-black animate-[pulse_2s_infinite]',
    privileges: ['إطار ذهبي متوهج', 'رسالة دخول ملكية للجميع', 'شارة الأسطورة الذهبية']
  },
  { 
    level: 12, 
    name: 'إلهي', 
    cost: 2000000, 
    color: 'text-white', 
    frameUrl: 'https://cdn-icons-png.flaticon.com/512/2165/2165039.png', 
    nameStyle: 'text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-slate-400 font-black',
    privileges: ['أرقى إطار ملكي على الإطلاق', 'دخول أسطوري في جميع الغرف', 'تغيير الـ ID لمرة واحدة مجاناً', 'حماية من الطرد']
  },
];
